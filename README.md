...
*   **Zero-Artifact In-Memory Strategy**: Documentation is processed **100% in memory** using absolute `file:///` resource resolution. This prevents repository bloat, eliminates temporary `-pass1.html` files, and ensures source HTML files remain untouched and pristine.
